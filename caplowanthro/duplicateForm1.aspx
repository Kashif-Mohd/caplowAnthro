<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="duplicateForm1.aspx.cs" Inherits="caplowanthro.duplicateForm1" %>
                ...
                <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." CssClass="footable" ForeColor="#333333" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Unique Mother ID">
                            <ItemTemplate>
                                <asp:LinkButton ID="Linkunique_mother_id" OnClick="Link_unique_mother_id" Text='<%#Eval("unique_mother_id") %>' runat="server" ToolTip="Show Detail"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
