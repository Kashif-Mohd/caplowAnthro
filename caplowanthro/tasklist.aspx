<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="tasklist.aspx.cs" Inherits="caplowanthro.tasklist" %>
        ...
        <div style="width: 100%; overflow: scroll; margin-top: 15px">
            <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Record Found." OnRowDataBound="OnRowDataBound" CssClass="footable" AllowSorting="false" ForeColor="#333333" AutoGenerateColumns="false">
                <Columns>
                    ...
                    <asp:BoundField DataField="followup_no" HeaderText="Followup Number" />
                    ...
                    <asp:BoundField DataField="" HeaderText="Complete Anthro" />
                </Columns>
